...
function updateCate(){
	window.open('/myweb/updateCatePopUp.mdo', '카테고리 수정', 'width=300, height=300')
}
function updateQ(){
	window.open('/myweb/updateQPopUp.mdo', '질문과 답변 수정', 'width=300, height=300')
}
</script>
</head>
<body>
					...
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<li><button style="border: 0; width: 100%; color: gray;" onclick="updateCate()">카테고리수정</button></li>
								</ul>
								<button style="border: 0; width: 100%; color: gray;" onclick="updateQ()">질문/답변 수정</button>
