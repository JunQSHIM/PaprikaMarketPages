...
<aside class="main-sidebar sidebar-light-orange elevation-4">
	...
	<a href="/myweb/Admin_page/layout/ad_main_layout.jsp"
		class="brand-link  navbar-white" style="background:orange">  <span
		class="brand-text font-weight-light pap">
		<h4 style="color:white; margin-top:5px; margin-left:30px;"><b>파 프 리 카 마 켓</b></h4></span>
	</a>
               ...
               with font-awesome or any other icon font library -->
				<li class="nav-item"><a href="#" class="nav-link"> <i
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item"><a
							href="/myweb/Admin_page/member/ad_memlist.jsp" class="nav-link">
				...
				<li class="nav-item"><a
					href="/myweb/Admin_page/singo/ad_singo_list.jsp" class="nav-link">
