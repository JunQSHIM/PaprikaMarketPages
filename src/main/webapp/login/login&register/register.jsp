...
$("#phoneCheck").keyup(function() {
	...
	if (pattern.test(phone) == false) {
		document.getElementById('result5').innerHTML = '<font color="red">올바른 전화번호 형식이 아닙니다.</font>';
		theForm.phone.focus();
		target.disabled = true;
	} else {
		setOutline(theForm.phone,"1px solid black");
...
$("#registerButton").click(function() {
	...
	if (!theForm.year.value) {
		setOutline(theForm.year,"2px solid red");
		document.getElementById('result2').innerHTML = '<font color="red">연도를 선택해주세요.</font>';
		theForm.year.focus();
		return;
	} else {
		setOutline(theForm.year,"1px solid black");
	...
	if (!theForm.month.value) {
		setOutline(theForm.month,"2px solid red");
		document.getElementById('result2').innerHTML = '<font color="red">월을 선택해주세요.</font>';
		theForm.month.focus();
		return;
	} else {
		setOutline(theForm.month,"1px solid black");
	...
	if (!theForm.day.value) {
		setOutline(theForm.day,"2px solid red");
		document.getElementById('result2').innerHTML = '<font color="red">일을 선택해주세요.</font>';
		theForm.day.focus();
		return;
	} else {
		setOutline(theForm.day,"1px solid black");
...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
			<form action="/myweb/login/main/mother.jsp" name="register" id="register">
