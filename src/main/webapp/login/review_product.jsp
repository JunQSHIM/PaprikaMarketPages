...
<link rel="stylesheet" type="text/css" href="./review_product_css/review_product.css">
<script type="text/javascript" src="./review_product_js/review_product.js"></script>
<%
