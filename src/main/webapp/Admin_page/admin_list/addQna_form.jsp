					...
					<div class="col-12">
						<div class="card">
							...
							<form action="qna.jsp" method="post" id="qnaForm">
								...
								<input type="button" id="addCategory" value="카테고리추가">
								<div id="tab-1" class="tab-content current">
									<div>
										<div class="flip"><input type="text" value="Q.운영정책"></div>
										<div class="panel" style="display: none;">
											<div>
												<input type="text" value="서로 존중하고 배려해요.">
												<input type="text" value="존댓말로 솔직하게 대화해요.">
												<input type="text" value="늦은 시간에는 채팅을 자제해 주세요.">
												<input type="text" value="택배 거래보다는 만나서 직거래하기로 해요.">
												<input type="text" value="거래는 만 14세 이상 부터 하기로 해요.">
												<input type="text" value="구매자, 판매자가 함께 노력하여 신뢰를 만들어요.">
											</div>
										</div>
									</div>
									<div>
										<div class="flip"><input type="text" value="Q.직거래 주의사항"></div>
										<div class="panel" style="display: none;">
											<div>
												<input type="text" value="누구나찾기 쉽고 안전한 공공장소에서 만나요.">
												<input type="text" value="서로의 집 앞까지 오더라도 집 밖에서 거래하기로 해요.">
												<input type="text" value="구매자는 판매자를 배려하며 물건 상태를 조심히 확인해요.">
												<input type="text" value="물품의 상태를 꼼꼼하게 확인해주세요.">
												<input type="text" value="높은 가격의 물품은판매자, 구매자 모두 더 신중하게 거래해요">
												<input type="text" value="직접 만나 구매한 경우 사용감으로 인한 환불은 어려워요.">
												<input type="text" value="거래 관련 모든 문제는 중고거래 게시판 거래 및 환불 정책을 따르고 있어요.">
											</div>
										</div>
									</div>
									<div>
										<div class="flip"><input type="text" value="Q.판매자 주의사항"></div>
										<div class="panel" style="display: none;">
											<div>
												<input type="text" value="직접 촬영한 사진으로 판매글을 작성해요.">
												<input type="text" value="실제 물품 사진이 아닌 경우 오해가 생길 수 있어요.">
												<input type="text" value="물품에 대한 설명을 자세히 써요.(특히. 주요 하자에 대한 내용은 꼭 명시!)">
												<input type="text" value="판매하기 전에 깨끗하게 세탁 또는 관리해요.">
											</div>
										</div>
									</div>
									<div>
										<div class="flip"><input type="text" value="Q.구매자 주의사항"></div>
										<div class="panel" style="display: none;">
											<div>
												<input type="text" value="판매글을 꼼꼼히 읽고 질문해요.">
												<input type="text" value="미리 신중하게 고민한 뒤 판매자와 장소에서 만나요.">
											</div>
										</div>
									</div>
								</div>
