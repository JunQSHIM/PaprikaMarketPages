...
public class AdminChartController {
	...
	//통계
			...
			@ResponseBody
			public  List<Integer> countWeek(Model model, ChartVO vo, @PathVariable("type") String type, int time) throws Exception{
				int mon=0;
				int tue=0;
				int wed=0;
				int thu=0;
			...
			@ResponseBody
			public  List<Integer> countMonth(Model model, ChartVO vo, @PathVariable("type") String type, int time) throws Exception{
				int jan=0;
				int feb=0;
				int mar=0;
				int apr=0;
