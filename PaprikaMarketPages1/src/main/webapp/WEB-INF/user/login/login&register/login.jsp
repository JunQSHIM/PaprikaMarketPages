			...
			<div class="card-body">
    			...
    			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
					...
					<div class="button-login" align="center">
						<a id="kakao-login-btn"	class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=<spring:eval expression="@property['KAKAO_REST_API_KEY']"/>&redirect_uri=http://ec2-43-201-10-18.ap-northeast-2.compute.amazonaws.com/myweb/kakaoLogin.do&response_type=code">
						<img
