...
<body>
	<form enctype="multipart/form-data" action="createProc.do" name="sellBoard" method="POST" onsubmit="Checkform()" >
		...
		<div class="grid_12 new_price">
			...
			<div class="grid_10 newdata">
				<div class="pri">
					<input type="text" id="price" name="price" placeholder=" 숫자만 입력해주세요." onkeydown="chkNum()"> 원
				</div>
			</div>
		</div>
			...
			<div class="grid_10 newdata">
				<div class="textbox">
					...
					<textarea class="text_area" rows="6"
						...
						name="prod_content" onkeyup="chkMsgLength(1000,prod_content,currentMsgLen);"></textarea>
					<br>
					<div class="hoxy">
