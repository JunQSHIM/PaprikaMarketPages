...
public class UserServiceImpl implements UserService{
	...
	public int insertUser(UserVO vo) throws Exception{
        ...
        sendMail.setText(
                ...
                "<br><a href='http://ec2-43-201-10-18.ap-northeast-2.compute.amazonaws.com/myweb/rEmail.do?email=" + vo.getEmail() +
                "&mail_key=" + mail_key +
	...
	public String getAccessToken(String authroize_code) {
		...
		try {
			...
			sb.append("&redirect_uri=http://ec2-43-201-10-18.ap-northeast-2.compute.amazonaws.com/myweb/kakaoLogin.do"); // 본인이 설정한 주소
